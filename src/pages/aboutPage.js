     ...
     <Col xs="8" md="6">
      <div>
       ...
       <p className="info-paragraph">
        I'm a <span className="info-with-color">Front End Developer</span> based
        in Egypt, Cairo.
        <br />I have a serious passion for writing code, while I Listen to good
        music Fan of <span className="info-with-color">Anjunadeep</span> and
        LoFi beats. I like to share music and take kindda good pictures <br />I
        can help build a nice atmosphere with people around me.
        <br />
        <br />
        tbc..
       </p>
